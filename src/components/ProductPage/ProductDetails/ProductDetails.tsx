    ...
    <div className="w-full lg:max-w-xl mx-auto bg-white p-4 lg:p-4 lg:mt-6">
      ...
      <div className="mb-3 lg:mb-4">
        <div className="flex items-center gap-2 text-xs lg:text-sm text-gray-600">
          <FontAwesomeIcon icon={faInfoCircle} className="text-gray-500 text-sm lg:text-base" />
      ...
      {/* Size Selection */}
      <div className="mb-3 lg:mb-4">
        <h3 className="text-sm lg:text-base font-semibold text-gray-900 mb-2 lg:mb-3">Select Size</h3>
      ...
      <div className="flex gap-2 lg:gap-3 mb-3 lg:mb-4">
       ...
       <div className="border-b border-gray-100 pb-2 mb-3 lg:mb-4">
         <div className="py-2">
           <h3 className="text-sm lg:text-base font-semibold text-gray-900 mb-2 lg:mb-3">Description & Fit</h3>
       ...
       <div className="border-b border-gray-100 pb-3 lg:pb-4">
         <div className="py-2">
           <h3 className="text-sm lg:text-base font-semibold text-gray-900 mb-2 lg:mb-3">Shipping</h3>
           <div className="grid grid-cols-2 gap-3 lg:gap-4">
             <div className="flex flex-col items-center text-center gap-1 lg:gap-2">
               <FontAwesomeIcon icon={faPercent} className="text-lg lg:text-2xl text-gray-500" />
               <div className="text-xs text-gray-600 font-medium">Disc 50%</div>
             </div>
             <div className="flex flex-col items-center text-center gap-1 lg:gap-2">
               <FontAwesomeIcon icon={faBox} className="text-lg lg:text-2xl text-gray-500" />
               <div className="text-xs text-gray-600 font-medium">Regular Package</div>
             </div>
             <div className="flex flex-col items-center text-center gap-1 lg:gap-2">
               <FontAwesomeIcon icon={faCalendar} className="text-lg lg:text-2xl text-gray-500" />
               <div className="text-xs text-gray-600 font-medium">3-4 Working Days</div>
             </div>
             <div className="flex flex-col items-center text-center gap-1 lg:gap-2">
               <FontAwesomeIcon icon={faTruck} className="text-lg lg:text-2xl text-gray-500" />
